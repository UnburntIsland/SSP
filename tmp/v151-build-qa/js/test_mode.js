...
(function (global) {
  ...
  var TestMode = {
    ...
    portalPreview: params.get("qaPortal") === "1",
    unlockStages: params.get("qaUnlockStages") === "1",
    achievementPersistence: params.get("qaAchievements") === "1",
    lobbyMaterials: Math.max(0, Number(params.get("qaMaterials")) || 0)
  };
    ...
    global.__TEST__ = {
      ...
      getState: function () {
        ...
        return {
          ...
          taiwanMap: global.App ? {
            enabled: !!global.App.taiwanMapEnabled,
            selectedStageId: global.App.selectedStageId,
            activeRegionId: global.GameData && global.GameData.getTaiwanRegionForStage
              ? (global.GameData.getTaiwanRegionForStage(global.App.selectedStageId) || {}).id || null
              : null
          } : null,
          lobby: global.Lobby ? {
          ...
          bossSpawnReason: g.bossSpawnReason || null,
          activeBosses: g.enemies ? g.enemies.filter(function (enemy) {
            return !!enemy && !enemy.dead && enemy.isBoss && (!g.stage || enemy.id === g.stage.bossId);
          }).length : 0,
          running: !!g.running,
          paused: !!g.paused,
